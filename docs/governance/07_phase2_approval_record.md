...
| Phase 2 gate decision | Sponsor | Pending | Pending | Pending |
...
governance artifact and its version before recording Phase 2 as passed.

## Gate declaration

**Phase 2 gate:** NOT PASSED  
**Phase 3 eligibility:** LOCKED
