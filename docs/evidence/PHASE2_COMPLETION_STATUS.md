...
4. Have a human independently review the labelled set, then approve or modify the 0.75 confidence threshold and component weights.
5. Assign named Data Architect, Domain Steward, Privacy Steward, Evaluation Owner, and Sponsor roles; only humans may change governance artifacts from `PROPOSED`.
